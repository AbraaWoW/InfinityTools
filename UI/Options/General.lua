...
local function ApplyTabSelectionColor(r, g, b, a)
    ...
    -- Dispatch to cross-addon panels (InfinityTools, InfinityBoss)
    if _G.RRT and _G.RRT.GlobalThemeCallbacks then
        for _, cb in ipairs(_G.RRT.GlobalThemeCallbacks) do
            cb(r, g, b, a)
        end
    end
end
