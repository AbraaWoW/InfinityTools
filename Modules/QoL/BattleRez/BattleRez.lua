...
rezFrame:SetFrameStrata("MEDIUM")
rezFrame:Hide()
...
local cooldown = CreateFrame("Cooldown", "$parentCooldown", rezFrame, "CooldownFrameTemplate")
cooldown:SetAllPoints()
cooldown:SetDrawEdge(false)
cooldown:SetSwipeColor(0, 0, 0, 0.7)
cooldown:SetHideCountdownNumbers(true)
cooldown:SetFrameLevel(rezFrame:GetFrameLevel() + 1)

local textOverlay = CreateFrame("Frame", nil, rezFrame)
textOverlay:SetAllPoints()
textOverlay:SetFrameStrata(rezFrame:GetFrameStrata())
textOverlay:SetFrameLevel(cooldown:GetFrameLevel() + 1)
textOverlay:EnableMouse(false)

local timerLabel = textOverlay:CreateFontString(nil, "OVERLAY")
...
if timerLabel.SetDrawLayer then
    timerLabel:SetDrawLayer("OVERLAY", 7)
end

local countLabel = textOverlay:CreateFontString(nil, "OVERLAY")
...
if countLabel.SetDrawLayer then
    countLabel:SetDrawLayer("OVERLAY", 7)
end
