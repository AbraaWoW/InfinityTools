...
local function BuildMidnightOptionsLeft()
    return {
        -- Imperator Averzian
        {
            type = "label",
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3176] and RRT.EncounterAlerts[3176].enabled) or false end,
            set         = function(self, _, value)
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3177] and RRT.EncounterAlerts[3177].enabled) or false end,
            set         = function(self, _, value)
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3179] and RRT.EncounterAlerts[3179].enabled) or false end,
            set         = function(self, _, value)
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3179] and RRT.EncounterAlerts[3179].CCAddsDisplay) or false end,
            set         = function(self, _, value)
                RRT.EncounterAlerts[3179] = RRT.EncounterAlerts[3179] or {}
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3178] and RRT.EncounterAlerts[3178].enabled) or false end,
            set         = function(self, _, value)
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3178] and RRT.EncounterAlerts[3178].HealthDisplay) or false end,
            set         = function(self, _, value)
                RRT.EncounterAlerts[3178] = RRT.EncounterAlerts[3178] or {}
        ...
        },
        {
            type        = "toggle",
            boxfirst    = true,
            name        = "Void Howl Circle",
            desc        = "Displays a 5-yard range circle around you during Void Howl (Hurlement du Vide). Shows a countdown to the explosion.",
            get         = function() return (RRT.EncounterAlerts[3178] and RRT.EncounterAlerts[3178].VoidHowlCircle) or false end,
            set         = function(self, _, value)
                RRT.EncounterAlerts[3178] = RRT.EncounterAlerts[3178] or {}
                RRT.EncounterAlerts[3178].VoidHowlCircle = value
            end,
            nocombat    = true,
            icontexture = 7448207,
            iconsize    = {16, 16},
        },
        {
            type        = "toggle",
            boxfirst    = true,
            name        = "Dread Breath Alert",
            desc        = "Affiche 'Urgent Move' quand vous etes cible par Souffle d'effroi (Dread Breath). Visible uniquement pour le joueur cible.",
            get         = function() return (RRT.EncounterAlerts[3178] and RRT.EncounterAlerts[3178].DreadBreathAlert) or false end,
            set         = function(self, _, value)
                RRT.EncounterAlerts[3178] = RRT.EncounterAlerts[3178] or {}
                RRT.EncounterAlerts[3178].DreadBreathAlert = value
            end,
            nocombat    = true,
            icontexture = 7448207,
            iconsize    = {16, 16},
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3180] and RRT.EncounterAlerts[3180].enabled) or false end,
            set         = function(self, _, value)
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3180] and RRT.EncounterAlerts[3180].TauntAlerts) or false end,
            set         = function(self, _, value)
                RRT.EncounterAlerts[3180] = RRT.EncounterAlerts[3180] or {}
        ...
        },
        {
            ...
            desc        = "Displays a Heal Absorb tick bar to track when a new heal absorb is applied. Useful for tanks and Timeline Reminders integration.",
            get         = function() return (RRT.EncounterAlerts[3180] and RRT.EncounterAlerts[3180].HealAbsorbTicks) or false end,
            set         = function(self, _, value)
                RRT.EncounterAlerts[3180] = RRT.EncounterAlerts[3180] or {}
                RRT.EncounterAlerts[3180].HealAbsorbTicks = value
            end,
            nocombat    = true,
            icontexture = 7448211,
            iconsize    = {16, 16},
        },
        {
            type        = "toggle",
            boxfirst    = true,
            name        = "Heal Absorb Display",
            desc        = "Affiche le montant de heal absorb en texte sur chaque membre du raid. Visible uniquement pour les healers.",
            get         = function() return (RRT.EncounterAlerts[3180] and RRT.EncounterAlerts[3180].HealAbsorbDisplay) or false end,
            set         = function(self, _, value)
                RRT.EncounterAlerts[3180] = RRT.EncounterAlerts[3180] or {}
                RRT.EncounterAlerts[3180].HealAbsorbDisplay = value
            end,
            nocombat    = true,
            icontexture = 7448211,
            iconsize    = {16, 16},
        },
        {
            ...
            boxfirst    = true,
            name        = "Dispel Glow",
            desc        = "Assigns Tyr's Wrath dispels with priority Healers > Warlocks > Dwarves, then glows only your assigned target's raid frame and announces 'Dispel [name]' as text + TTS.",
            get         = function() return (RRT.EncounterAlerts[3180] and RRT.EncounterAlerts[3180].DispelGlow) or false end,
            set         = function(self, _, value)
                RRT.EncounterAlerts[3180] = RRT.EncounterAlerts[3180] or {}
                RRT.EncounterAlerts[3180].DispelGlow = value
            end,
            nocombat    = true,
            icontexture = 7448211,
            iconsize    = {16, 16},
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3181] and RRT.EncounterAlerts[3181].enabled) or false end,
            set         = function(self, _, value)
...
local function BuildMidnightOptionsRight()
    return {
        -- Chimaerus
        {
            type = "label",
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3306] and RRT.EncounterAlerts[3306].enabled) or false end,
            set         = function(self, _, value)
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3182] and RRT.EncounterAlerts[3182].enabled) or false end,
            set         = function(self, _, value)
        ...
        },
        {
            ...
            get         = function() return (RRT.EncounterAlerts[3183] and RRT.EncounterAlerts[3183].enabled) or false end,
            set         = function(self, _, value)
...
local function BuildOptions()
    local options = {}
    local general = BuildGeneralOptions()

    -- Match the original Encounter Alerts layout: intro text + font size,
    -- then the encounter toggles in a single scrollable page.
    if general[3] then tinsert(options, general[3]) end
    if general[4] then tinsert(options, general[4]) end
    if general[5] then tinsert(options, general[5]) end

    for _, entry in ipairs(BuildMidnightOptionsLeft()) do
        tinsert(options, entry)
    end

    tinsert(options, { type = "breakline" })
    tinsert(options, {
        type = "label",
    ...
    for _, entry in ipairs(BuildMidnightOptionsRight()) do
        tinsert(options, entry)
    end
...
RRT_NS.UI.Options.EncounterAlerts = {
    ...
    BuildMidnightOptionsLeft  = BuildMidnightOptionsLeft,
    BuildMidnightOptionsRight = BuildMidnightOptionsRight,
