...
local function BuildCDNotePanel(panel)
    ...
    editTopLabel:SetTextColor(0.733, 0.4, 1.0, 1)
    RRT_NS.ThemeColorCallbacks = RRT_NS.ThemeColorCallbacks or {}
    tinsert(RRT_NS.ThemeColorCallbacks, function(r, g, b) editTopLabel:SetTextColor(r, g, b, 1) end)
    ...
    local function OpenImportPopup()
        if not ImportNotePopup then
            ...
            lbl:SetTextColor(0.733, 0.4, 1.0, 1)
    ...
    dispTopLabel:SetTextColor(0.733, 0.4, 1.0, 1)
    tinsert(RRT_NS.ThemeColorCallbacks, function(r, g, b) dispTopLabel:SetTextColor(r, g, b, 1) end)
