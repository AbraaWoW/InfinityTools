...
--
    SML_MT_font["Damage Numbers"] = [[Fonts\ARKai_C.ttf]]
    SML_MT_font["Default"]     = [[Fonts\ARKai_T.ttf]]
    SML_MT_font["Chat"]     = [[Fonts\ARHei.ttf]]
--
    lib.DefaultMedia["font"] = "Default" -- someone from zhCN please adjust if needed
--
elseif locale == "zhTW" then
    LOCALE_MASK = lib.LOCALE_BIT_zhTW
--
    SML_MT_font["Tooltip"] = [[Fonts\bHEI00M.ttf]]
    SML_MT_font["Chat"]     = [[Fonts\bHEI01B.ttf]]
    SML_MT_font["Damage Numbers"] = [[Fonts\bKAI00M.ttf]]
    SML_MT_font["Default"]     = [[Fonts\bLEI00D.ttf]]
--
    lib.DefaultMedia["font"] = "Default" -- someone from zhTW please adjust if needed
