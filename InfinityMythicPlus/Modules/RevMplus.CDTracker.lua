...
local function RaidPumpQueue()
    ...
    while #RaidQueue > 0 do
        ...
        if UnitExists(unit) then
            ...
            if guid then
                RaidQueued[guid] = nil
                -- NotifyInspect is not a protected function: callable in and out of combat.
                -- No CanInspect gate — out-of-range members would be silently skipped;
                -- we let the timeout handle the case where INSPECT_READY never fires.
                raidActiveGUID = guid
