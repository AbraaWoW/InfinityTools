...
EXSP.DispelBleed_List = { 245742, 377344, 396716, 468659, 1216985, 1253739, 1266488 }                                                                                     --Bleed
EXSP.DispelCurse_List = { 1258434, 1264186, 1281636 }                                                                                                                     --Curse
EXSP.DispelDisease_List = { 1246666, 1258459 }                                                                                                                            --Disease
EXSP.DispelEnrage_List = { 377389, 390938, 1216459, 1254678, 1255765, 1259132, 1264036 }                                                                                  --Enrage
EXSP.DispelMagic_List = { 388392, 468966, 1214038, 1216298, 1216860, 1245068, 1248689, 1249815, 1254175, 1254306, 1254670, 1255187, 1255434, 1256008, 1258437, 1258448, 1258826, 1259255, 1259731, 1260709, 1261921, 1262526, 1263783, 1265561, 1270079, 1271623, 1273356, 1277557, 1280330, 1282055, 1284627 } --Magic
EXSP.DispelPoison_List = { 473795, 1216825 }                                                                                                                              --Poison

EXSP.MechanicAsleep_List = { }                                        --Sleep
EXSP.MechanicBleeding_List = { 245742, 377344, 396716, 468659, 1216985, 1253739, 1266488 } --Bleed
EXSP.MechanicDisoriented_List = { 390938, 1255765 }                   --Disorient
EXSP.MechanicEnraged_List = { }                                       --Enrage
EXSP.MechanicFleeing_List = { 1214038, 1258997, 1259794, 1266381, 1269631, 1282055 } --Fear
EXSP.MechanicFrozen_List = { }                                        --Freeze
EXSP.MechanicPolymorphed_List = { 468966, 1256008 }                   --Polymorph
EXSP.MechanicRooted_List = { }                                        --Root
EXSP.MechanicSnared_List = { 1258437, 1261921, 1262509, 1263766, 1264186, 1269283 } --Snare
EXSP.MechanicStunned_List = { 152953, 378011, 468442, 470212, 474075 } --Stun
